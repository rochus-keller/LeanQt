...
void QToolBoxPrivate::Page::setText(const QString &text) { button->setText(text); }

void QToolBoxPrivate::Page::setIcon(const QIcon &is) { button->setIcon(is); }

#ifndef QT_NO_TOOLTIP
void QToolBoxPrivate::Page::setToolTip(const QString &tip) { button->setToolTip(tip); }
QString QToolBoxPrivate::Page::toolTip() const { return button->toolTip(); }
#endif

QString QToolBoxPrivate::Page::text() const { return button->text(); }
QIcon QToolBoxPrivate::Page::icon() const { return button->icon(); }
