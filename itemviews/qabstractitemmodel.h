...
class Q_WIDGETS_EXPORT QModelIndex
{
...
Q_WIDGETS_EXPORT QDebug operator<<(QDebug, const QModelIndex &);
#endif
...
class Q_WIDGETS_EXPORT QPersistentModelIndex
{
public:
...
#ifndef QT_NO_DEBUG_STREAM
    friend Q_WIDGETS_EXPORT QDebug operator<<(QDebug, const QPersistentModelIndex &);
#endif
};
...
#ifndef QT_NO_DEBUG_STREAM
Q_WIDGETS_EXPORT QDebug operator<<(QDebug, const QPersistentModelIndex &);
#endif
...
class Q_WIDGETS_EXPORT QAbstractItemModel : public QObject
{
    Q_OBJECT
...
class Q_WIDGETS_EXPORT QAbstractTableModel : public QAbstractItemModel
{
    Q_OBJECT
...
class Q_WIDGETS_EXPORT QAbstractListModel : public QAbstractItemModel
{
    Q_OBJECT
