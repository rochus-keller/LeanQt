...
#endif
#endif
        const QStringList rawPaths = QString::fromLocal8Bit(pEnv.constData()).split(sep, QString::SkipEmptyParts);
...
#ifndef QT_NO_COREAPPLICATION
static inline QString _translate(const char * context,const char * key) { return QCoreApplication::translate(context,key); }
#else
static inline QString _translate(const char * context,const char * key) { return key; }
#endif
...
QString QStandardPaths::displayName(StandardLocation type)
{
    ...
    case DesktopLocation:
        return _translate("QStandardPaths", "Desktop");
    case DocumentsLocation:
        return _translate("QStandardPaths", "Documents");
    case FontsLocation:
        return _translate("QStandardPaths", "Fonts");
    case ApplicationsLocation:
        return _translate("QStandardPaths", "Applications");
    case MusicLocation:
        return _translate("QStandardPaths", "Music");
    case MoviesLocation:
        return _translate("QStandardPaths", "Movies");
    case PicturesLocation:
        return _translate("QStandardPaths", "Pictures");
    case TempLocation:
        return _translate("QStandardPaths", "Temporary Directory");
    case HomeLocation:
        return _translate("QStandardPaths", "Home");
    case CacheLocation:
        return _translate("QStandardPaths", "Cache");
    case GenericDataLocation:
        return _translate("QStandardPaths", "Shared Data");
    case RuntimeLocation:
        return _translate("QStandardPaths", "Runtime");
    case ConfigLocation:
        return _translate("QStandardPaths", "Configuration");
    case GenericConfigLocation:
        return _translate("QStandardPaths", "Shared Configuration");
    case GenericCacheLocation:
        return _translate("QStandardPaths", "Shared Cache");
    case DownloadLocation:
        return _translate("QStandardPaths", "Download");
    case AppDataLocation:
    case AppLocalDataLocation:
        return _translate("QStandardPaths", "Application Data");
    case AppConfigLocation:
        return _translate("QStandardPaths", "Application Configuration");
    }
    // not reached
    return QString();
}
