...
#endif
#if defined(QT_NO_URL_VARIANT) || defined(QT_BOOTSTRAPPED)
template<> struct TypeDefinition<QUrl> { static const bool IsAvailable = false; };
#endif
#if defined(QT_NO_JSON) || defined(QT_BOOTSTRAPPED)
...
#endif
#ifdef QT_NO_QOBJECT
template<> struct TypeDefinition<QObject*> { static const bool IsAvailable = false; };
#endif
#ifdef QT_NO_REGEXP
