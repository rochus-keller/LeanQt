...
key_t QSystemSemaphorePrivate::handle(QSystemSemaphore::AccessMode mode)
{
    ...
    if (-1 == built) {
        errorString = _TRANSLATE("%1: unable to make key", "QSystemSemaphore").arg(QLatin1String("QSystemSemaphore::handle:"));
        error = QSystemSemaphore::KeyError;
        return -1;
    }
    createdFile = (1 == built);
    ...
    if (-1 == unix_key) {
        errorString = _TRANSLATE("%1: ftok failed", "QSystemSemaphore").arg(QLatin1String("QSystemSemaphore::handle:"));
        error = QSystemSemaphore::KeyError;
        return -1;
    }
